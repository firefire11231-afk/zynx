local Config = {
    ...
    ServiceId       = 30120, -- Your PlatoBoost Service ID
    PlatoSecret     = "6340101a-8698-47fb-9212-b71d69e718da", -- Your PlatoBoost Secret Key
    ...
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/firefire11231-afk/zynx/refs/heads/main/script.lua", -- The raw URL of your main script
    
    -- [4] Social Media Settings (Set to true to show, false to hide)
    ShowDiscord     = true,
    DiscordURL      = "https://discord.gg/WJGbnqwNan",
    ...
    HubName         = "ZynX Hub Freemium", -- The main title shown at the top of the GUI
    HubDescription  = "Blox Fruits join discord for premium(paid)" -- The text shown below the title
}
